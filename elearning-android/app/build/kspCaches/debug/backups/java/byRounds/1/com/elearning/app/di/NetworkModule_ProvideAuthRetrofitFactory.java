...
public final class NetworkModule_ProvideAuthRetrofitFactory implements Factory<Retrofit> {
  ...
  public NetworkModule_ProvideAuthRetrofitFactory(Provider<OkHttpClient> clientProvider) {
  ...
  public static NetworkModule_ProvideAuthRetrofitFactory create(
    ...
    return new NetworkModule_ProvideAuthRetrofitFactory(clientProvider);
  }

  public static Retrofit provideAuthRetrofit(OkHttpClient client) {
    return Preconditions.checkNotNullFromProvides(NetworkModule.INSTANCE.provideAuthRetrofit(client));
  }
}
